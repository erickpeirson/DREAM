...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OAuthAccessToken.expires'
        db.add_column(u'dolon_oauthaccesstoken', 'expires',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OAuthAccessToken.expires'
        db.delete_column(u'dolon_oauthaccesstoken', 'expires')
