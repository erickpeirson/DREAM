...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QueryEvent.after'
        db.alter_column(u'dolon_queryevent', 'after', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'QueryEvent.before'
        db.alter_column(u'dolon_queryevent', 'before', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'QueryEvent.after'
        db.alter_column(u'dolon_queryevent', 'after', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'QueryEvent.before'
        db.alter_column(u'dolon_queryevent', 'before', self.gf('django.db.models.fields.DateTimeField')(null=True))
