...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DiffBotRequest.attemped'
        db.delete_column(u'dolon_diffbotrequest', 'attemped')

        # Adding field 'DiffBotRequest.attempted'
        db.add_column(u'dolon_diffbotrequest', 'attempted',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DiffBotRequest.attemped'
        db.add_column(u'dolon_diffbotrequest', 'attemped',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'DiffBotRequest.attempted'
        db.delete_column(u'dolon_diffbotrequest', 'attempted')
