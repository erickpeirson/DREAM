...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Context.text_content'
        db.add_column(u'dolon_context', 'text_content',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Context.author'
        db.add_column(u'dolon_context', 'author',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Context.language'
        db.add_column(u'dolon_context', 'language',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Context.text_content'
        db.delete_column(u'dolon_context', 'text_content')

        # Deleting field 'Context.author'
        db.delete_column(u'dolon_context', 'author')

        # Deleting field 'Context.language'
        db.delete_column(u'dolon_context', 'language')
