...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DiffBotRequest'
        db.create_table(u'dolon_diffbotrequest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('attemped', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('completed', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('parameters', self.gf('dolon.models.ListField')(default=[''])),
            ('response', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'dolon', ['DiffBotRequest'])


    def backwards(self, orm):
        # Deleting model 'DiffBotRequest'
        db.delete_table(u'dolon_diffbotrequest')
