...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field diffbot_requests on 'Context'
        m2m_table_name = db.shorten_name(u'dolon_context_diffbot_requests')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('context', models.ForeignKey(orm[u'dolon.context'], null=False)),
            ('diffbotrequest', models.ForeignKey(orm[u'dolon.diffbotrequest'], null=False))
        ))
        db.create_unique(m2m_table_name, ['context_id', 'diffbotrequest_id'])


    def backwards(self, orm):
        # Removing M2M table for field diffbot_requests on 'Context'
        db.delete_table(db.shorten_name(u'dolon_context_diffbot_requests'))
    ...
    models = {
        ...
        u'dolon.diffbotrequest': {
            ...
            'attemped': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
