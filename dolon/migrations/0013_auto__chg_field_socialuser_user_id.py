...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SocialUser.user_id'
        db.alter_column(u'dolon_socialuser', 'user_id', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'SocialUser.user_id'
        db.alter_column(u'dolon_socialuser', 'user_id', self.gf('django.db.models.fields.IntegerField')(null=True))
