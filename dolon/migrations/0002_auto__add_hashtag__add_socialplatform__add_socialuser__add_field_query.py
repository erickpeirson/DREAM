...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'dolon_hashtag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('string', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'dolon', ['HashTag'])

        # Adding model 'SocialPlatform'
        db.create_table(u'dolon_socialplatform', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ))
        db.send_create_signal(u'dolon', ['SocialPlatform'])

        # Adding model 'SocialUser'
        db.create_table(u'dolon_socialuser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('handle', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('platform', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dolon.SocialPlatform'])),
            ('profile_url', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'dolon', ['SocialUser'])

        # Adding field 'QueryEvent.search_by'
        db.add_column(u'dolon_queryevent', 'search_by',
                      self.gf('django.db.models.fields.CharField')(default='ST', max_length=2),
                      keep_default=False)

        # Adding field 'QueryEvent.user'
        db.add_column(u'dolon_queryevent', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dolon.SocialUser'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'QueryEvent.tag'
        db.add_column(u'dolon_queryevent', 'tag',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dolon.HashTag'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'QueryEvent.before'
        db.add_column(u'dolon_queryevent', 'before',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'QueryEvent.after'
        db.add_column(u'dolon_queryevent', 'after',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'QueryEvent.rangeEnd'
        db.alter_column(u'dolon_queryevent', 'rangeEnd', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'QueryEvent.querystring'
        db.alter_column(u'dolon_queryevent', 'querystring_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['dolon.QueryString']))

        # Changing field 'QueryEvent.rangeStart'
        db.alter_column(u'dolon_queryevent', 'rangeStart', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Deleting model 'HashTag'
        db.delete_table(u'dolon_hashtag')

        # Deleting model 'SocialPlatform'
        db.delete_table(u'dolon_socialplatform')

        # Deleting model 'SocialUser'
        db.delete_table(u'dolon_socialuser')

        # Deleting field 'QueryEvent.search_by'
        db.delete_column(u'dolon_queryevent', 'search_by')

        # Deleting field 'QueryEvent.user'
        db.delete_column(u'dolon_queryevent', 'user_id')

        # Deleting field 'QueryEvent.tag'
        db.delete_column(u'dolon_queryevent', 'tag_id')

        # Deleting field 'QueryEvent.before'
        db.delete_column(u'dolon_queryevent', 'before')

        # Deleting field 'QueryEvent.after'
        db.delete_column(u'dolon_queryevent', 'after')


        # Changing field 'QueryEvent.rangeEnd'
        db.alter_column(u'dolon_queryevent', 'rangeEnd', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'QueryEvent.querystring'
        db.alter_column(u'dolon_queryevent', 'querystring_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['dolon.QueryString']))

        # Changing field 'QueryEvent.rangeStart'
        db.alter_column(u'dolon_queryevent', 'rangeStart', self.gf('django.db.models.fields.IntegerField')(default=1))
    ...
    models = {
        ...
        u'dolon.queryevent': {
            ...
            'after': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'before': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'rangeEnd': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
