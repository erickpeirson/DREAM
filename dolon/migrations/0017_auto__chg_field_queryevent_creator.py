...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QueryEvent.creator'
        db.alter_column(u'dolon_queryevent', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'QueryEvent.creator'
        raise RuntimeError("Cannot reverse this migration. 'QueryEvent.creator' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'QueryEvent.creator'
        db.alter_column(u'dolon_queryevent', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
